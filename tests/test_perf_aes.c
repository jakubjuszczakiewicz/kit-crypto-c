...
uint64_t test_aes_enc_128(unsigned int count)
{
  kit_aes_key lkey;
  ...
  for (unsigned int i = 0; i < count; i++)
    kit_aes_encrypt_block(&lkey, output, plaintext[i & 1]);
...
uint64_t test_aes_enc_192(unsigned int count)
{
  kit_aes_key lkey;
...
uint64_t test_aes_enc_256(unsigned int count)
{
  kit_aes_key lkey;
...
uint64_t test_aes_dec_128(unsigned int count)
{
  kit_aes_key lkey;
  kit_aes_init_128(&lkey, key);
  ...
  for (unsigned int i = 0; i < count; i++)
    kit_aes_decrypt_block(&lkey, output, encrypted_128[i & 1]);
...
uint64_t test_aes_dec_192(unsigned int count)
{
  kit_aes_key lkey;
  kit_aes_init_192(&lkey, key);
  ...
  for (unsigned int i = 0; i < count; i++)
    kit_aes_decrypt_block(&lkey, output, encrypted_192[i & 1]);
...
uint64_t test_aes_dec_256(unsigned int count)
{
  kit_aes_key lkey;
  kit_aes_init_256(&lkey, key);
  ...
  for (unsigned int i = 0; i < count; i++)
    kit_aes_decrypt_block(&lkey, output, encrypted_256[i & 1]);
...
{
  uint64_t enc128 = test_aes_enc_128(TEST_COUNT);
  uint64_t enc192 = test_aes_enc_192(TEST_COUNT);
  uint64_t enc256 = test_aes_enc_256(TEST_COUNT);
  uint64_t dec128 = test_aes_dec_128(TEST_COUNT);
  uint64_t dec192 = test_aes_dec_192(TEST_COUNT);
  uint64_t dec256 = test_aes_dec_256(TEST_COUNT);

  printf("Encrypt AES 128 time: %f sec\n", (double)enc128 / 1000000000.0);
  printf("Encrypt AES 192 time: %f sec\n", (double)enc192 / 1000000000.0);
  printf("Encrypt AES 256 time: %f sec\n", (double)enc256 / 1000000000.0);

  printf("Decrypt AES 128 time: %f sec\n", (double)dec128 / 1000000000.0);
  printf("Decrypt AES 192 time: %f sec\n", (double)dec192 / 1000000000.0);
  printf("Decrypt AES 256 time: %f sec\n", (double)dec256 / 1000000000.0);
